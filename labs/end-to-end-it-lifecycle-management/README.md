...
<img src="/labs/end-to-end-it-lifecycle-management/resources/sc-icon.png" width="400"> <img src="/labs/end-to-end-it-lifecycle-management/resources/snow-icon2.png" width="400">
